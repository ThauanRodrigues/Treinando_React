    ...
    <section>
      ...
      <div className={styles.sobreNos}>
        ...
        <div className={styles.sobreNos__texto}>
          <p>
            Nós da Casa da Massa oferecemos a vocês, nossos queridos clientes, a
            Massa Italiana Caseira mais saborosa e sofisticada de Mangabeira!
          ...
          <p>
            Para acompanhar as massas italianas, A Casa de Massas possui uma
            reserva de vinhos especiais, que harmonizam perfeitamente com o seu
            parto, seja carne ou massa!
          </p>
        </div>
      </div>
